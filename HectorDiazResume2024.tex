...
\begin{minipage}[t]{0.45\textwidth} % 45% of the page width for name
	...
	\colorbox{teal}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{Hector}}}}} % First name
	
	\colorbox{teal}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{Diaz}}}}} % Last name
...
\begin{minipage}[t]{0.4\textwidth} % 40% of the page width for the introduction text
	...
	Creative, detail-oriented, software engineer with a deep interest in human-centered technology. Proven track record for being a gifted motivator, guiding individuals toward making sustainable change. Looking to combine my skills as a communicator and my passion for technology and innovation to create sustainable change on a greater scale.   \\ 
\end{minipage}
